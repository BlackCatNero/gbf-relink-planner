...
const SKILL_EFFECTS = {
  ...
  // [attack]
  "배수": ["최대 효과 시 공격력 +100%"],
  "혼신": ["최대 효과 시 공격력 +70%", "최소 효과 시 공격력 +10.5%"],
  "크리티컬 대미지": ["크리티컬 피해 +50%"],
  "약점 공격": ["약점 공격 시 대미지 +70%", "백어택 시 대미지 +70%"],
  "폭군": ["공격력 +50%", "최대 HP 감소 -20%"],
  "결사의 각오": ["공격력 +50%", "동료로부터 HP 회복 불가"],
  "대미지 상한": ["기본 공격·어빌리티·오의 대미지 상한 +250%"],
  "어빌리티 대미지": ["어빌리티 대미지 +100%"],
  "연계 공격": ["링크 어택 대미지 +100% · 오의 대미지 +50%", "체인 버스트 대미지 +20~50% · 링크 카운터 상승량 +50%"],
  "콤보 보너스": ["최대 효과 시 공격력 +100%"],
  "추가 대미지": ["추가 피해 20%", "발동 확률 100%"],
  "베르세르크": ["추가 대미지 20% (공격력 25000↑ 시 100%, 20000 미만 미발동)"],
  "스파르타": ["추가 대미지 20% (최대 HP 80000↑ 시 100%, 50000 미만 미발동)"],
  "콤보 피니시": ["콤보 피니시 피해 +50%"],
  "차지 어택": ["차지 공격 피해 +50%"],
  "모으기 회심": ["차지 공격 크리티컬 확률 +60%"],
  "퀵 차지": ["차지 시간 단축 -30%", "공격력 +20%"],
  "집중포화": ["원거리 공격 피해 +50%"],
  "투척": ["피해 +100%"],
  "약화 상태 특효": ["피해 +30%"],
  "오버 드라이브 특효": ["피해 +100%"],
  "브레이크 특효": ["피해 +200%"],
  "선제": ["공격력 +60% (퀘스트 시작 후 3분간)"],
  "수라": ["전투 시작 시 HP 50% 감소", "공격력 +30%"],
  "가드 반격": ["스턴치 +100%", "공격력 +50%"],
  "회피 반격": ["무적 시간 +3초", "공격력 +30%"],
  "적수공권": ["어빌리티 0/1/2/3개: 공격력 +120%/90%/60%/30%"],
  "궁지": ["공격력 +80% (가드·회피 불가)"],
  "미세한 차이": ["공격력 +30%", "대미지 상한 +30%", "피격 시 반드시 기절"],
  "건곤일척": ["기본 공격 대미지가 일정 확률로 1~4배 (4배 시 상한 무시, 실패 시 1)"],
  "유리 속성 변환": ["무속성 제외 모든 공격이 유리 속성화", "상한 무시 대미지 +20%"],
  "천성의 염": ["대미지 상한 +50%"],
  "천성의 황": ["공격력 +20%", "대미지 상한 +70% (HP 75% 이상)"],
  "천성의 계": ["대미지 상한 +70%", "최대 HP -30%"],
  "천성의 지": ["주는 대미지 +10%", "동료로부터 HP 회복 불가"],
  "천성의 설": ["주는 대미지 +15%"],
  ...
  "금강": ["최대 HP +80%"],
  "견수": ["최대 효과 시 방어력 +70%"],
  "강건": ["HP 100% 시 방어력 +30%", "HP 25% 미만 시 방어력 +4.5%"],
  "버티기": ["피해 감소 -15% (움츠러들기 무효 중)"],
  "가드 성능": ["가드 브레이크 상한 +50%"],
  "회피 성능": ["구르기 횟수 7", "무적 시간 증가"],
  "항전": ["방어력 +30%", "HP 회복 15%"],
  "정신일도": ["무적 시간 +3초", "방어력 +20%", "HP 회복 10%"],
  "회피 거리": ["구르기 동작의 거리가 길어진다"],
  "프래즐 닷지": ["공격력 -50%", "회피가 무조건 저스트 회피 판정"],
  "슈퍼 얼티메이트 Just 회피": ["저스트 회피 성공 후 무적 시간 중 대미지 상한 +50%"],
  "부동": ["끌어당기기·밀어내기에 대한 내성"],
  "기절 내성": ["기절 지속 시간·대미지 -100% (무효)"],
  "빙결 내성": ["빙결 지속 시간·대미지 -100% (무효)"],
  "물감옥 내성": ["물감옥 지속 시간·대미지 -100% (무효)"],
  "모래인간 내성": ["모래인간 지속 시간·대미지 -100% (무효)"],
  "독 내성": ["독 지속 시간·대미지 -100% (무효)"],
  "슬로우 내성": ["슬로우 지속 시간·대미지 -100% (무효)"],
  "작열 내성": ["작열 지속 시간·대미지 -100% (무효)"],
  "마비 내성": ["마비 지속 시간·대미지 -100% (무효)"],
  "재앙 내성": ["재앙 지속 시간·대미지 -100% (무효)"],
  "어빌리티 봉인 내성": ["어빌리티 봉인 지속 시간 -100% (무효)"],
  "오의 봉인 내성": ["오의 봉인 지속 시간 -100% (무효)"],
  "레지스트 얼터": ["자은의 불꽃 무효"],
  "공격 Down 내성": ["공격 DOWN 지속 시간 -100% (무효)"],
  "방어 Down 내성": ["방어 DOWN 지속 시간 -100% (무효)"],

  // [support]
  "회복 성능": ["회복량 및 회복량 상한 +50%"],
  "리제너레이션": ["HP 회복 5%"],
  ...
  "맹렬": ["쿨타임 감소 -2%"],
  "고양": ["오의 게이지 상승량 +30%"],
  "격노": ["오의 게이지 상승량 +5%", "어빌리티 쿨타임 감소 -5%"],
  "명경지수": ["무적 시간 +3초", "오의 게이지 상승량 +5%", "어빌리티 쿨타임 감소 -5%"],
  "만능약": ["큐어 포션 사용 시 모든 상태 이상 회복", "2개 장착 시 약화 무효 부여"],

  // [special]
  "포션 보유 수": ["큐어 포션 +3 · 올 포션 +5 · 메가 포션 +5 · 소생약 +2"],
  "근성": ["쿨타임 120초"],
  "자동 부활": ["쿨타임 120초"],
  "차지 강화": ["방어력 +20%", "차지 중 움츠러들기 무효"],
  "도발": ["적대심 +50"],
  "은신": ["적대심 -50"],
  "게의 공명": ["리틀 스니퍼 구조 수에 따라 공격력 (최대 +1000)"],
  "게의 보은": ["최대 HP +20%", "피해 감소 -10%"],
  "가공할 만한 칠흑의 게 진": ["공격력 +20% / 방어력 +2% / 크리티컬 확률 +20% / 대미지 상한 +10% / 대미지 5%의 추가 대미지 발생 / 2%의 대미지 UP 효과 부여 / 매초 최대 HP의 1% 회복 / 대미지의 2% 회복"],
  "칠흑의 인연": ["빈사 복귀 시간 -30%", "복귀 시 공격력 +10% · 5% 대미지 UP · 대미지 상한 +5%"],
  "움츠러들기 무효": ["상시 움츠러들기 무효", "받는 대미지 -30%"],
  "획득 경험치": ["획득 경험치 +30%"],
  "획득 루피": ["획득 루피 +60%"],
  "획득 MSP": ["획득 MSP +30%"],
  ...
  "수호자의 결의": ["주는 대미지 10%의 추가 대미지 효과", "대미지 상한 +15%"],
  "수호자의 긍지": ["쿨타임 -5%"],
  ...
  "나비칼날의 몽환": ["호접 수 +1"],
  "나비칼날의 무예": ["발동률 50%"],
  "나비칼날의 투기": ["오의 게이지 상승량 -50%", "저스트 전환 시 15초간 15% 대미지 강화 · 10% 추가 대미지 부여"],
  ...
  "제왕의 투기": ["대미지 강화 +30% · 10% 추가 대미지 부여 (30초)"],
  ...
  "군청의 검섬": ["쿨타임 -20%"],
  "군청의 투기": ["인과 포식 상태 시 대미지 +20% · 추가 대미지 +10%", "지속해서 받는 대미지 +50%"],
  "고귀한 칼날의 세레나데": ["쿨타임 -10%"],
  "고귀한 칼날의 론도": ["대미지 상한 +10%", "백중 연격 저스트 추가 대미지 발동 시 칼날 게이지 상승량 +20%"],
