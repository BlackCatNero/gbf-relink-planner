...
const SIGIL_VALUES = {
  "HP 흡수": {
    effects: [
      { label: '대미지 흡수', sign: '+', unit: '%', pts: [[1, 0.2], [15, 2.0], [30, 3.5], [45, 5.0]] },
    ],
  },
  "가드 반격": {
    effects: [
  ...
  "강건": {
    effects: [
      { label: '방어력(HP 100%)', sign: '+', unit: '%', pts: [[1, 5.0], [15, 22.0], [30, 30.0]] },
      { label: '방어력(HP 25%)', sign: '+', unit: '%', pts: [[1, 0.7], [15, 3.3], [30, 4.5]] },
    ],
  },
  "건곤일척": {
    effects: [
      { t: '확률로 대미지 1~4배 (실패 시 1)' },
    ],
  },
  "게의 공명": {
    effects: [
  ...
  "게의 보은": {
    effects: [
      ...
      { label: '받는 대미지', sign: '-', unit: '%', pts: [[15, 10.0]] },
    ],
  },
  "격노": {
    effects: [
      { label: '오의 게이지 상승', sign: '+', unit: '%', pts: [[1, 0.5], [15, 3.5], [30, 5.0]] },
      { label: '쿨타임', sign: '-', unit: '%', pts: [[1, 0.5], [15, 3.5], [30, 5.0]] },
    ],
  },
  "견수": {
    effects: [
      { label: '방어력(최대)', sign: '+', unit: '%', pts: [[1, 4.0], [15, 35.0], [30, 50.0], [45, 70.0]] },
    ],
  },
  "결사의 각오": {
    effects: [
  ...
  "고양": {
    effects: [
      { label: '오의 게이지 상승', sign: '+', unit: '%', pts: [[1, 5.0], [15, 12.0], [30, 19.5], [45, 30.0]] },
    ],
  },
  "공격 Down 내성": {
    effects: [
      { label: '지속시간', sign: '-', unit: '%', pts: [[1, 10], [15, 70], [30, 100]] },
    ],
  },
  "공격력": {
    effects: [
  ...
  "근성": {
    effects: [
      { label: '재발동', sign: '', unit: '초', pts: [[1, 600.0], [15, 170.0], [20, 120.0]] },
    ],
  },
  "금강": {
    effects: [
  ...
  "만능약": {
    effects: [
      { t: '큐어 포션 사용 시 상태 이상 회복 · 2개 시 약화 무효' },
    ],
  },
  "맹렬": {
    effects: [
      { label: '쿨타임', sign: '-', unit: '%', pts: [[1, 0.1], [15, 1.5], [20, 2.0]] },
    ],
  },
  "명경지수": {
    effects: [
  ...
  "모으기 회심": {
    effects: [
      { label: '크리티컬 확률', sign: '+', unit: '%', pts: [[1, 6.0], [15, 54.0], [20, 60.0]] },
    ],
  },
  "물감옥 내성": {
    effects: [
  ...
  "배수": {
    effects: [
      { label: '공격력(최대)', sign: '+', unit: '%', pts: [[1, 10.0], [15, 70.0], [30, 100.0]] },
    ],
  },
  "버티기": {
    effects: [
      { label: '받는 대미지', sign: '-', unit: '%', pts: [[1, 1.0], [15, 15.0]] },
    ],
  },
  "베르세르크": {
    effects: [
      { t: '공격력에 따라 추격 20% (25000↑ 시 100%)' },
    ],
  },
  "베타 코드": {
    effects: [
  ...
  "브레이크 특효": {
    effects: [
      { label: '주는 대미지', sign: '+', unit: '%', pts: [[1, 20.0], [15, 140.0], [30, 200.0]] },
    ],
  },
  "빙결 내성": {
    effects: [
  ...
  "약점 공격": {
    effects: [
      { label: '약점 부위 대미지', sign: '+', unit: '%', pts: [[1, 4.0], [15, 36.0], [30, 51.0], [45, 70.0]] },
      { label: '배후 대미지', sign: '+', unit: '%', pts: [[1, 4.0], [15, 36.0], [30, 51.0], [45, 70.0]] },
    ],
  },
  "약화 상태 특효": {
    effects: [
      { label: '주는 대미지', sign: '+', unit: '%', pts: [[1, 5.0], [15, 22.0], [30, 30.0]] },
    ],
  },
  "어빌리티 대미지": {
    effects: [
  ...
  "연계 공격": {
    effects: [
      ...
      { label: '링크 카운터 상승', sign: '+', unit: '%', pts: [[1, 5.0], [15, 31.0], [30, 50.0]] },
    ],
  },
  "오버 드라이브 특효": {
    effects: [
      { label: '주는 대미지', sign: '+', unit: '%', pts: [[1, 10.0], [15, 70.0], [30, 100.0]] },
    ],
  },
  "움츠러들기 무효": {
    effects: [
  ...
  "집중포화": {
    effects: [
      { label: '원거리 대미지', sign: '+', unit: '%', pts: [[1, 5.0], [15, 35.0], [30, 50.0]] },
    ],
  },
  "차지 강화": {
    effects: [
  ...
  "차지 어택": {
    effects: [
      { label: '차지 공격 대미지', sign: '+', unit: '%', pts: [[1, 5.0], [15, 35.0], [30, 50.0]] },
    ],
  },
  "체력": {
    effects: [
  ...
  "추가 대미지": {
    effects: [
      { label: '추격 대미지', sign: "+", unit: "%", flat: 20 },
  ...
  "콤보 피니시": {
    effects: [
      { label: '콤보 피니시 대미지', sign: '+', unit: '%', pts: [[1, 5.0], [15, 35.0], [30, 50.0]] },
    ],
  },
  "퀵 어빌리티": {
    effects: [
      { label: '쿨타임', sign: '-', unit: '%', pts: [[1, 1.0], [15, 10.0], [30, 13.0], [45, 20.0]] },
    ],
  },
  "퀵 차지": {
    effects: [
      { label: '모으기 시간', sign: '-', unit: '%', pts: [[1, 3.0], [15, 21.0], [30, 30.0]] },
      { label: '공격력', sign: '+', unit: '%', pts: [[1, 2.0], [15, 14.0], [30, 20.0]] },
    ],
  },
  "크리티컬 대미지": {
    effects: [
      { label: '크리티컬 대미지', sign: '+', unit: '%', pts: [[1, 5.0], [15, 35.0], [30, 50.0]] },
    ],
  },
  "크리티컬 확률": {
    effects: [
  ...
  "포션 보유 수": {
    effects: [
      ...
      { label: '부활약', sign: '+', unit: '', pts: [[1, 0.0], [15, 2.0]] },
    ],
  },
  "폭군": {
    effects: [
      { label: '공격력', sign: '+', unit: '%', pts: [[1, 5.0], [15, 35.0], [30, 50.0]] },
      { label: '최대 HP', sign: '-', unit: '%', pts: [[1, 20.0]] },
    ],
  },
  "프래즐 닷지": {
    effects: [
      { t: '회피=저스트 회피 (확장팩: 대미지 DOWN 부여)' },
    ],
  },
  "항전": {
    effects: [
  ...
  "혼신": {
    effects: [
      { label: '공격력(최대)', sign: '+', unit: '%', pts: [[1, 8.0], [15, 50.0], [30, 70.0]] },
      { label: '공격력(최소)', sign: '+', unit: '%', pts: [[1, 1.2], [15, 7.5], [30, 10.5]] },
    ],
  },
  "회복 성능": {
    effects: [
      { label: '회복량·상한', sign: '+', unit: '%', pts: [[1, 5.0], [15, 35.0], [30, 50.0]] },
    ],
  },
  "회피 거리": {
    effects: [
  ...
  "회피 성능": {
    effects: [
      { label: '연속 회피', sign: '+', unit: '', pts: [[11, 4.0], [12, 5.0], [13, 6.0], [14, 7.0], [15, 7.0]] },
    ],
  },
  "획득 MSP": {
    effects: [
      { label: 'MSP', sign: '+', unit: '%', pts: [[1, 2.0], [15, 15.0], [30, 22.5], [45, 30.0]] },
    ],
  },
  "획득 경험치": {
    effects: [
      { label: '경험치', sign: '+', unit: '%', pts: [[1, 1.0], [15, 15.0], [30, 22.5], [45, 30.0]] },
    ],
  },
  "획득 루피": {
    effects: [
      { label: '루피', sign: '+', unit: '%', pts: [[1, 2.0], [15, 30.0], [30, 46.0], [45, 60.0]] },
    ],
  },
};
